    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 rounded-lg p-4 border border-yellow-200 dark:border-yellow-800">
        <div className="flex items-center justify-between gap-4">
          <div>
            <h3 className="text-base font-semibold text-yellow-900 dark:text-yellow-100 mb-1 flex items-center gap-2">
            ...
            <div className="space-y-2">
              <Button 
                onClick={() => {
                  ...
                  a.href = url;
                  a.download = `snapchat-ads-templates-${new Date().toISOString().split('T')[0]}.json`;
                  a.click();
              ...
              <div>
                <input
                  ...
                  className="hidden"
                  id="import-templates-snapchat"
                />
                <Button
                  onClick={() => document.getElementById('import-templates-snapchat')?.click()}
                  icon={Upload}
                  size="sm"
                  variant="secondary"
                  className="w-full"
